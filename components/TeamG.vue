              ...
              <h2 class="text-xl sm:text-3xl font-semibold text-center">
                ...
                <div class="team flex flex-col justify-around md:flex-row">
                    <div class="mt-14 sm:mt-20 flex flex-col items-center">
                        <img src="../static/person1.jpg" class="w-72 rounded-md shadow-lg"/>
                        ...
                        <img src="../static/person2.jpg" class="w-72 mt-12 rounded-md shadow-lg"/>
                    ...
                    <div class="mt-14 sm:mt-20 flex flex-col items-center ">
                        <img src="../static/person3.jpg" class="w-72 rounded-md shadow-lg"/>
                        ...
                        <img src="../static/person4.jpg" class="w-72 mt-12 rounded-md shadow-lg"/>
                        <h3 class="text-lg font-medium mt-3 text-left  w-60">Jhonathan Michaels</h3>
                         <span class="text-gray-600 font-light text-sm text-left w-60">Diseñador Industrial</span>
                        <p class="text-gray-600 text-sm w-60 h-20 mt-1">Su campo de acción es crear los propotipos gráficos por los que se crean barras, sillas, iluminaria y toda clase de objetos de interiores.</p>
                    </div>
